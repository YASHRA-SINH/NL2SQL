...
Pre-seeds the default clinic PersistentAgentMemory with 15+ known-good
...
# Re-use the shared agent_memory instance from app.vanna_setup
from app.vanna_setup import agent_memory
